...
- Store (that has even power to get stuff from the play store without your data getting stolen or been asked to sign in using prob aurora store to do this)
- Podcast (idk)
- Settings (aosp settings but with stuff changed)
- Gallery (aosp gallery but with more stuff)
- Camera (aosp normal) 
